<template>
  <div style="display: flex;">
    ...
    <aside
      id="sidebar"
      style="width: 40%; background: #29233c; padding: 40px 20px;"
    >
      <div style="display: flex;">
        <!-- Left content -->
        <sidebar
          style="flex: 1; height: 100vh;"
          @generate="handleFormChange"
          :active="activeTab"
        />
...
export default {
  ...
  methods: {
    ...
    print() {
      ...
      const filename = this.resume.basics.name + " Resume.pdf";
      const divWidth = paper.offsetWidth;
      const divHeight = paper.offsetHeight;

      paper.setAttribute("style", "width:1000px");
